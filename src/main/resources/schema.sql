...
INSERT [dbo].[compensation] ([id], [images], [accident_address], [accident_time], [payment], [contract_id], [status], [customer_id], [manager_id], [staff_id]) VALUES (1, N'https://i.imgflip.com/5zn5dt.jpg', N'Ða Hội', CAST(N'2022-01-01T00:00:00.000' AS DateTime), 5425000, 1, N'Đã duyệt', 1, 1, 1)
INSERT [dbo].[compensation] ([id], [images], [accident_address], [accident_time], [payment], [contract_id], [status], [customer_id], [manager_id], [staff_id]) VALUES (2, N'https://i.imgflip.com/56at69.jpg', N'Hoài Ðức', CAST(N'2022-01-01T00:00:00.000' AS DateTime), NULL, 2, N'Đang chờ xử lý', 2, NULL, NULL)
...
INSERT [dbo].[compensation] ([id], [images], [accident_address], [accident_time], [payment], [contract_id], [status], [customer_id], [manager_id], [staff_id]) VALUES (4, N'https://i.pinimg.com/736x/f7/42/48/f74248291f310e8', N'Thái Nguyên', CAST(N'2021-01-06T00:00:00.000' AS DateTime), NULL, 4, N'Đang chờ xử lý', 4, NULL, NULL)
INSERT [dbo].[compensation] ([id], [images], [accident_address], [accident_time], [payment], [contract_id], [status], [customer_id], [manager_id], [staff_id]) VALUES (5, N'https://i.imgflip.com/2ufmch.jpg', N'Ða Hội', CAST(N'2022-01-01T00:00:00.000' AS DateTime), 29529000, 5, N'Đã duyệt', 5, 1, 5)
INSERT [dbo].[compensation] ([id], [images], [accident_address], [accident_time], [payment], [contract_id], [status], [customer_id], [manager_id], [staff_id]) VALUES (6, N'ags', N'Hải Dương', CAST(N'2020-11-03T00:00:00.000' AS DateTime), 1000000, 1, N'Đã duyệt', 1, 1, 1)
...
INSERT [dbo].[contract] ([id], [pattern], [type_id], [start_date], [end_date], [status], [manager_id], [staff_id], [buyer_id], [customer_id]) VALUES (10, N'new', 3, CAST(N'2023-03-15T00:00:00.000' AS DateTime), CAST(N'2025-03-15T00:00:00.000' AS DateTime), N'Đang chờ xử lý.', NULL, NULL, 7, 1)
INSERT [dbo].[contract] ([id], [pattern], [type_id], [start_date], [end_date], [status], [manager_id], [staff_id], [buyer_id], [customer_id]) VALUES (11, N'new', 3, CAST(N'2023-03-15T00:00:00.000' AS DateTime), CAST(N'2025-03-15T00:00:00.000' AS DateTime), N'Đang chờ xử lý.', NULL, NULL, 8, 1)
